...
const Message = () => {
  ...
  return (
    ...
    {/* Chat Panel (Fixed Structure, Scroll Only in Chat Area) */}
        ...
        <>
          ...
          <div className="p-2 bg-white border-t flex items-center gap-4">
            ...
            <button
              ...
              className="w-28 bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              Send
            </button>
          </div>
